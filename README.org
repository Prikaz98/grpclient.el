...
[[https://img.shields.io/static/v1?label=grpclient.el&message=0.1.0&color=blue][Version]]

#+html: <img alt="" src="https://img.shields.io/static/v1?label=grpclient.el&message=0.1.0&color=blue"/>
